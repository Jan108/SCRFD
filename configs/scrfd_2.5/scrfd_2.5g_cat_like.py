...
data = dict(
    ...
    train=dict(
        ...
        ann_file='/mnt/data/afarec/data/OAFI_full/labels_yunet/labels_cat_like_train.txt',
    ...
    val=dict(
        type='RetinaFaceDataset',
        ann_file='/mnt/data/afarec/data/OAFI_full/labels_yunet/labels_cat_like_validation.txt',
    ...
    test=dict(
        type='RetinaFaceDataset',
        ann_file='/mnt/data/afarec/data/OAFI_full/labels_yunet/labels_cat_like_test.txt',
