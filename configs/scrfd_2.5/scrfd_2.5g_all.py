...
data = dict(
    ...
    train=dict(
        ...
        ann_file='/mnt/data/afarec/data/OAFI_full/labels_yunet/labels_all_train.txt',
    ...
    val=dict(
        type='RetinaFaceDataset',
        ann_file='/mnt/data/afarec/data/OAFI_full/labels_yunet/labels_all_validation.txt',
    ...
    test=dict(
        type='RetinaFaceDataset',
        ann_file='/mnt/data/afarec/data/OAFI_full/labels_yunet/labels_all_test.txt',
