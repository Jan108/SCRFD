...
data = dict(
    ...
    train=dict(
        ...
        ann_file='/mnt/data/afarec/data/OAFI_full/labels_yunet/labels_cat_train.txt',
    ...
    val=dict(
        type='RetinaFaceDataset',
        ann_file='/mnt/data/afarec/data/OAFI_full/labels_yunet/labels_cat_validation.txt',
    ...
    test=dict(
        type='RetinaFaceDataset',
        ann_file='/mnt/data/afarec/data/OAFI_full/labels_yunet/labels_cat_test.txt',
