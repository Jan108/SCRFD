...
data = dict(
    ...
    train=dict(
        ...
        ann_file=data_root+'/labels_yunet/labels_bird_train.txt',
    ...
    val=dict(
        type='RetinaFaceDataset',
        ann_file=data_root+'/labels_yunet/labels_bird_validation.txt',
    ...
    test=dict(
        type='RetinaFaceDataset',
        ann_file=data_root+'/labels_yunet/labels_bird_test.txt',
