...
data = dict(
    ...
    train=dict(
        ...
        ann_file=data_root+'/labels_yunet/labels_cat_like_train.txt',
    ...
    val=dict(
        type='RetinaFaceDataset',
        ann_file=data_root+'/labels_yunet/labels_cat_like_validation.txt',
    ...
    test=dict(
        type='RetinaFaceDataset',
        ann_file=data_root+'/labels_yunet/labels_cat_like_test.txt',
