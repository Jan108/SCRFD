...
data = dict(
    ...
    train=dict(
        ...
        ann_file=data_root+'/labels_yunet/labels_small_animals_train.txt',
    ...
    val=dict(
        type='RetinaFaceDataset',
        ann_file=data_root+'/labels_yunet/labels_small_animals_validation.txt',
    ...
    test=dict(
        type='RetinaFaceDataset',
        ann_file=data_root+'/labels_yunet/labels_small_animals_test.txt',
