...
data = dict(
    ...
    train=dict(
        ...
        ann_file=data_root+'/labels_yunet/labels_dog_train.txt',
    ...
    val=dict(
        type='RetinaFaceDataset',
        ann_file=data_root+'/labels_yunet/labels_dog_validation.txt',
    ...
    test=dict(
        type='RetinaFaceDataset',
        ann_file=data_root+'/labels_yunet/labels_dog_test.txt',
